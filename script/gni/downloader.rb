...
begin
  ...
  ds.do_downloads(true) {|status| puts 'calling preprocessor'; system(RAILS_ROOT + '/script/gni/preprocessor.rb -e ' + OPTIONS[:environment]) unless status == ImportScheduler::UNCHANGED}
rescue RuntimeError
  raise 
ensure
