class CreateNameRanks < ActiveRecord::Migration
  def self.up
    ...
    add_column :import_name_index_records, :name_rank_id, :integer
    ...
    remove_column :import_name_index_records, :rank
  end

  def self.down
    add_column :import_name_index_records, :rank, :string
    ...
    remove_column :import_name_index_records, :name_rank_id
