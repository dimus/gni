    ...
    if @rails_env == 'development'
      ...
      yield  [
        {:class => DataSource},
        {
          ...
          :refresh_period_days => 10,
          :metadata_url => "http://nhm.org/bees/metadata",
          :data_url  => "http://nhm.org/bees/data.xml",
          :logo_url => "http://nhm.org/bees/logo.gif",
        ...
        },
        {
          ...
          :refresh_period_days => 12,
          :metadata_url => "http://nhm.org/birds/metadata",
          :data_url  => "http://nhm.org/birds/data.xml",
          :data_zip_compressed => false,
          :logo_url => "http://nhm.org/birds/logo.gif",
          # :rights => "top secret",
